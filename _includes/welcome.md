...
## Lời người dịch {#translator_note}

Tựa đề tài liệu _PHP: Con Đường Chính Đạo_ được mình tái sử dụng dựa trên bản dịch của anh Trần Nguyễn Chung, một trong những người đầu tiên dịch bản dịch này, rất cảm ơn anh. Tuy nhiên,  bản dịch gốc hiện tại không còn được duy trì và version của PHP tại thời điểm dịch là 7.x nên mình đã fork repository gốc của bản dịch và dịch lại theo ý của mình. Do đây là một tài liệu lập trình, rất nhiều thuật ngữ không thể dịch sang tiếng Việt (hoặc khi dịch sẽ không thể bao hàm ý dịch nên mình sẽ giữ nguyên từ gốc tiếng Anh và bổ sung thêm phần ghi chú nếu có thể).

Ngoài ra, bản dịch cũng có nhiều thay đổi về mặt layout so với tài liệu gốc, ví dụ như một số phần font chữ và links dẫn mục lục đã bị lỗi nên mình đã cập nhật lại. Nếu bạn đọc thấy có gì thiếu sót xin vui lòng tạo issue trong repository của mình trên Github hoặc email mình tại địa chỉ email dinhhoangbaochan@gmail.com. Cảm ơn mọi người.
...
## Cách để đóng góp {#how-to-contribute}

Giúp mình đóng góp thêm cho cộng đồng PHP nói chung và các bạn lập trình viên PHP mới nói riêng nhé! [Xem tại Github của mình][2]
